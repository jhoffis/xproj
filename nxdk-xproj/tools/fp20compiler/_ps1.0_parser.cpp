...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_REG = 6,                        /* REG  */
  YYSYMBOL_DEF = 7,                        /* DEF  */
  YYSYMBOL_ADDROP = 8,                     /* ADDROP  */
  YYSYMBOL_BLENDOP = 9,                    /* BLENDOP  */
  YYSYMBOL_10_ = 10,                       /* ','  */
  YYSYMBOL_11_ = 11,                       /* '+'  */
  YYSYMBOL_YYACCEPT = 12,                  /* $accept  */
  YYSYMBOL_WholeEnchilada = 13,            /* WholeEnchilada  */
  YYSYMBOL_Defs = 14,                      /* Defs  */
  YYSYMBOL_Def = 15,                       /* Def  */
  YYSYMBOL_AddrOps = 16,                   /* AddrOps  */
  YYSYMBOL_AddrOp = 17,                    /* AddrOp  */
  YYSYMBOL_BlendOps = 18,                  /* BlendOps  */
  YYSYMBOL_BlendOp = 19,                   /* BlendOp  */
  YYSYMBOL_MaybePlus = 20,                 /* MaybePlus  */
  YYSYMBOL_Newlines = 21                   /* Newlines  */
};
...
{
       0,    71,    71,    78,    85,    92,    99,   106,   113,   120,
     130,   138,   150,   164,   172,   183,   193,   205,   222,   230,
     242,   256,   272,   292,   294,   300,   304
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "HEADER", "NEWLINE",
  "NUMBER", "REG", "DEF", "ADDROP", "BLENDOP", "','", "'+'", "$accept",
  "WholeEnchilada", "Defs", "Def", "AddrOps", "AddrOp", "BlendOps",
  "BlendOp", "MaybePlus", "Newlines", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* WholeEnchilada: HEADER Newlines Defs AddrOps BlendOps  */
#line 72 "ps1.0_grammar.y"
        {
		DBG_MESG("dbg: WholeEnchilada", line_number);		
		ps10::invoke((yyvsp[-2].consts), (yyvsp[-1].lines), (yyvsp[0].lines));
	}
#line 1158 "_ps1.0_parser.cpp"
    break;

  case 3: /* WholeEnchilada: Newlines HEADER Newlines Defs AddrOps BlendOps  */
#line 79 "ps1.0_grammar.y"
        {
		DBG_MESG("dbg: WholeEnchilada", line_number);		
		ps10::invoke((yyvsp[-2].consts), (yyvsp[-1].lines), (yyvsp[0].lines));
	}
#line 1167 "_ps1.0_parser.cpp"
    break;

  case 4: /* WholeEnchilada: HEADER Newlines AddrOps BlendOps  */
#line 86 "ps1.0_grammar.y"
        {
		DBG_MESG("dbg: WholeEnchilada", line_number);		
		ps10::invoke( 0, (yyvsp[-1].lines), (yyvsp[0].lines));
	}
#line 1176 "_ps1.0_parser.cpp"
    break;

  case 5: /* WholeEnchilada: Newlines HEADER Newlines AddrOps BlendOps  */
#line 93 "ps1.0_grammar.y"
        {
		DBG_MESG("dbg: WholeEnchilada", line_number);		
		ps10::invoke( 0, (yyvsp[-1].lines), (yyvsp[0].lines));
	}
#line 1185 "_ps1.0_parser.cpp"
    break;

  case 6: /* WholeEnchilada: HEADER Newlines Defs BlendOps  */
#line 100 "ps1.0_grammar.y"
        {
		DBG_MESG("dbg: WholeEnchilada", line_number);		
		ps10::invoke((yyvsp[-1].consts), 0, (yyvsp[0].lines));
	}
#line 1194 "_ps1.0_parser.cpp"
    break;

  case 7: /* WholeEnchilada: Newlines HEADER Newlines Defs BlendOps  */
#line 107 "ps1.0_grammar.y"
        {
		DBG_MESG("dbg: WholeEnchilada", line_number);		
		ps10::invoke((yyvsp[-1].consts), 0, (yyvsp[0].lines));
	}
#line 1203 "_ps1.0_parser.cpp"
    break;

  case 8: /* WholeEnchilada: HEADER Newlines BlendOps  */
#line 114 "ps1.0_grammar.y"
        {
		DBG_MESG("dbg: WholeEnchilada", line_number);		
		ps10::invoke( 0, 0, (yyvsp[0].lines));
	}
#line 1212 "_ps1.0_parser.cpp"
    break;

  case 9: /* WholeEnchilada: Newlines HEADER Newlines BlendOps  */
#line 121 "ps1.0_grammar.y"
        {
		DBG_MESG("dbg: WholeEnchilada", line_number);		
		ps10::invoke( 0, 0, (yyvsp[0].lines));
	}
#line 1221 "_ps1.0_parser.cpp"
    break;
...
#line 1241 "_ps1.0_parser.cpp"
    break;

  case 12: /* Def: DEF REG ',' NUMBER ',' NUMBER ',' NUMBER ',' NUMBER Newlines  */
...
#line 1255 "_ps1.0_parser.cpp"
    break;

  case 13: /* AddrOps: AddrOp  */
...
#line 1265 "_ps1.0_parser.cpp"
    break;

  case 14: /* AddrOps: AddrOps AddrOp  */
...
#line 1275 "_ps1.0_parser.cpp"
    break;

  case 15: /* AddrOp: ADDROP REG Newlines  */
...
#line 1287 "_ps1.0_parser.cpp"
    break;

  case 16: /* AddrOp: ADDROP REG ',' REG Newlines  */
...
#line 1301 "_ps1.0_parser.cpp"
    break;

  case 17: /* AddrOp: ADDROP REG ',' REG ',' REG Newlines  */
...
#line 1317 "_ps1.0_parser.cpp"
    break;

  case 18: /* BlendOps: BlendOp  */
...
#line 1327 "_ps1.0_parser.cpp"
    break;

  case 19: /* BlendOps: BlendOps BlendOp  */
...
#line 1337 "_ps1.0_parser.cpp"
    break;

  case 20: /* BlendOp: MaybePlus BLENDOP REG ',' REG Newlines  */
...
#line 1353 "_ps1.0_parser.cpp"
    break;

  case 21: /* BlendOp: MaybePlus BLENDOP REG ',' REG ',' REG Newlines  */
...
#line 1371 "_ps1.0_parser.cpp"
    break;

  case 22: /* BlendOp: MaybePlus BLENDOP REG ',' REG ',' REG ',' REG Newlines  */
...
#line 1391 "_ps1.0_parser.cpp"
    break;

  case 23: /* MaybePlus: %empty  */
#line 292 "ps1.0_grammar.y"
  { (yyval.ival)=0; }
#line 1397 "_ps1.0_parser.cpp"
    break;

  case 24: /* MaybePlus: '+'  */
#line 295 "ps1.0_grammar.y"
  { (yyval.ival)=1; }
#line 1403 "_ps1.0_parser.cpp"
    break;

  case 25: /* Newlines: NEWLINE  */
#line 301 "ps1.0_grammar.y"
 {}
#line 1409 "_ps1.0_parser.cpp"
    break;

  case 26: /* Newlines: Newlines NEWLINE  */
#line 305 "ps1.0_grammar.y"
 {}
#line 1415 "_ps1.0_parser.cpp"
    break;


#line 1419 "_ps1.0_parser.cpp"
