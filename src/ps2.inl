...
pb_push1(p, NV097_SET_COMBINER_FACTOR0 + 0 * 4,
    MASK(0xFF000000, 0x00)
    | MASK(0x00FF0000, 0xFF)
    | MASK(0x0000FF00, 0x00)
    | MASK(0x000000FF, 0x00));
p += 2;
pb_push1(p, NV097_SET_COMBINER_FACTOR1 + 0 * 4,
    MASK(0xFF000000, 0x00)
    | MASK(0x00FF0000, 0x00)
    | MASK(0x0000FF00, 0xFF)
    | MASK(0x000000FF, 0xFF));
p += 2;
pb_push1(p, NV097_SET_COMBINER_COLOR_ICW + 0 * 4,
    MASK(NV097_SET_COMBINER_COLOR_ICW_A_SOURCE, 0x1) | MASK(NV097_SET_COMBINER_COLOR_ICW_A_ALPHA, 0) | MASK(NV097_SET_COMBINER_COLOR_ICW_A_MAP, 0x6)
    ...
    | MASK(NV097_SET_COMBINER_COLOR_ICW_C_SOURCE, 0x2) | MASK(NV097_SET_COMBINER_COLOR_ICW_C_ALPHA, 0) | MASK(NV097_SET_COMBINER_COLOR_ICW_C_MAP, 0x6)
    | MASK(NV097_SET_COMBINER_COLOR_ICW_D_SOURCE, 0x4) | MASK(NV097_SET_COMBINER_COLOR_ICW_D_ALPHA, 0) | MASK(NV097_SET_COMBINER_COLOR_ICW_D_MAP, 0x6));
p += 2;
pb_push1(p, NV097_SET_COMBINER_COLOR_OCW + 0 * 4,
    ...
    | MASK(NV097_SET_COMBINER_COLOR_OCW_SUM_DST, 0x4)
...
pb_push1(p, NV097_SET_COMBINER_CONTROL,
    MASK(NV097_SET_COMBINER_CONTROL_FACTOR0, NV097_SET_COMBINER_CONTROL_FACTOR0_EACH_STAGE)
    | MASK(NV097_SET_COMBINER_CONTROL_FACTOR1, NV097_SET_COMBINER_CONTROL_FACTOR1_EACH_STAGE)
